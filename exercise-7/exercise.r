...
lowerest.turnover <- arrange(team.data, Ratio) %>% 
...
team.data <- mutate(team.data, assists = AST / G) %>% 
             arrange(-assists)
...
# a data.frame of the team with the better field-goal percentage (FG.). The returned 
# data.frame should include the team name, field-goal percentage (FG.), and points (PTS).
